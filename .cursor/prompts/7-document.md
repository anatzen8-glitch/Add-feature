# Document (Step 7) – Update Documentation Task
...
- **CHANGELOG.md**: Add entry under "Unreleased" section
  ...
  - If CHANGELOG.md doesn't exist, create it with an "Unreleased" section at the top. Use [Keep a Changelog](https://keepachangelog.com/) format if helpful.
